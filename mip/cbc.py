...
class SolverCbc(Solver):
    ...
    def set_int_param(self, param: str, value: int):
        cbc_set_parameter(self, param, str(value))
        return ()
        
    def set_str_param(self, attr: str, value: str):
        cbc_set_parameter(self, attr, value)
    ...
    def optimize(self, relax: bool = False) -> OptimizationStatus:
        ...
        if m.lazy_constrs_generator is not None:
            ...
            if self.model.preprocess == 0:
                ...
                cbc_set_parameter(self, "preprocess", "on")
            elif self.model.preprocess == 2:
                cbc_set_parameter(self, "preprocess", "equal")
            elif self.model.preprocess == 3:
                cbc_set_parameter(self, "preprocess", "aggregate")
            elif self.model.preprocess == 4:
    ...
    def set_parameter(self, param: str, value: str):
        cbc_set_parameter(self, param, value)
